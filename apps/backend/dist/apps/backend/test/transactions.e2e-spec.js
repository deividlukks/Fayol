    ...
    describe('POST /api/v1/transactions', () => {
        ...
        it('deve criar uma receita', () => {
            return request(app.getHttpServer())
                ...
                .send({
                accountId,
                categoryId: (categoriesResponse) => categoriesResponse.body.find((c) => c.type === 'income')?.id,
                movementType: 'income',
                launchType: 'income',
                amount: 5000.0,
    ...
    describe('GET /api/v1/transactions', () => {
        ...
        it('deve filtrar transações por tipo', () => {
            return request(app.getHttpServer())
                ...
                .expect(200)
                .expect((res) => {
                expect(res.body.every((t) => t.movementType === 'expense')).toBe(true);
            });
        });
        it('deve filtrar transações por conta', () => {
            return request(app.getHttpServer())
                ...
                .expect(200)
                .expect((res) => {
                expect(res.body.every((t) => t.accountId === accountId)).toBe(true);
            });
        });
