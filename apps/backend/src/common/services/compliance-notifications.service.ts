...
export class ComplianceNotificationsService {
  ...
  async notifyDataExportReady(
    ...
    try {
      ...
      this.logger.error('Failed to queue data export notification email', error instanceof Error ? error.stack : error);
      throw error;
    }
  }
  ...
  async notifyAccountDeletionScheduled(
    ...
    try {
      ...
      this.logger.debug(`Email job queued successfully for account deletion scheduled notification`);
    } catch (error) {
      this.logger.error('Failed to queue account deletion scheduled email', error instanceof Error ? error.stack : error);
      throw error;
    }
  }
  ...
  async notifyAccountDeletionImminent(
    ...
    try {
      ...
      this.logger.error('Failed to queue account deletion imminent email', error instanceof Error ? error.stack : error);
      throw error;
    }
  }
  ...
  async notifyAccountDeleted(email: string): Promise<void> {
    ...
    try {
      ...
      this.logger.error('Failed to queue account deleted email', error instanceof Error ? error.stack : error);
      throw error;
    }
  }
  ...
  async notifyConsentWithdrawn(
    ...
    try {
      ...
      this.logger.error('Failed to queue consent withdrawn email', error instanceof Error ? error.stack : error);
      throw error;
    }
  }
  ...
  async notifyConsentExpired(
    ...
    try {
      ...
      this.logger.error('Failed to queue consent expired email', error instanceof Error ? error.stack : error);
      throw error;
    }
  }
}
