import { Controller, Post, Body, HttpCode, HttpStatus, UseGuards, Get, Request, Response, UnauthorizedException } from '@nestjs/common';
...
import { validatePassword, getPasswordStrength, getPasswordSuggestions } from '../../../common/utils/password-validator';
...
export class AuthController {
  ...
  @ApiResponse({ status: 429, description: 'Muitas tentativas. Aguarde 15 minutos antes de tentar novamente.' })
  ...
  @ApiResponse({ status: 429, description: 'Muitas tentativas. Aguarde antes de tentar novamente.' })
  ...
  @ApiOperation({
    ...
    description: 'Endpoint público para validar se uma senha atende aos requisitos de segurança. Útil para feedback em tempo real no frontend.'
  })
  @ApiBody({
    schema: {
      type: 'object',
