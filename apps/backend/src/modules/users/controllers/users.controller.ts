import { Controller, Get, Post, Body, Patch, Param, UseGuards, Delete, BadRequestException, HttpCode, HttpStatus } from '@nestjs/common';
...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description: 'Permite que o usuário autenticado altere sua senha. Requer senha atual e nova senha forte.'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({ status: 400, description: 'Senha atual incorreta ou nova senha não atende aos requisitos.' })
  ...
  @ApiOperation({
    ...
    description: 'ATENÇÃO: Esta operação é irreversível! Todos os dados do usuário serão permanentemente deletados.'
  })
  deleteMyAccount(
    @CurrentUser() user: User,
