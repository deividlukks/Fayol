...
describe('UsersModule Integration', () => {
  ...
  describe('User Retrieval Flow', () => {
    ...
    it('should throw NotFoundException when user not found by id', async () => {
      ...
      await expect(usersService.findOne('nonexistent-id')).rejects.toThrow('Usuário não encontrado.');
    });
  ...
  describe('User Update Flow', () => {
    ...
    it('should throw NotFoundException when updating non-existent user', async () => {
      ...
      await expect(usersService.update('nonexistent-id', updateDto)).rejects.toThrow('Usuário não encontrado.');
