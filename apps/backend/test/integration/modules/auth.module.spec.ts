...
describe('AuthModule Integration', () => {
  ...
  describe('User Registration Flow', () => {
    ...
    it('should prevent duplicate email registration', async () => {
      ...
      await expect(usersService.create(registerDto)).rejects.toThrow('Usuário já cadastrado com este e-mail.');
    });
  });
  ...
  describe('Password Reset Flow', () => {
    ...
    it('should reject expired reset token', async () => {
      ...
      await expect(authService.resetPassword(resetPasswordDto)).rejects.toThrow('Token expirado. Solicite um novo reset de senha.');
    });
  });
