...
describe('AuthService', () => {
  ...
  describe('forgotPassword', () => {
    ...
    it('should generate reset token and return success message when user exists', async () => {
      ...
      expect(result).toHaveProperty('message', 'Se o email existe, um link de recuperação foi enviado.');
  ...
  describe('resetPassword', () => {
    ...
    it('should reset password successfully with valid token', async () => {
      ...
      expect(result).toHaveProperty('message', 'Senha alterada com sucesso! Você já pode fazer login.');
    ...
    it('should throw BadRequestException when token is invalid', async () => {
      ...
      await expect(service.resetPassword(resetPasswordDto)).rejects.toThrow('Token inválido ou expirado.');
    });
    ...
    it('should throw BadRequestException when token is expired', async () => {
      ...
      await expect(service.resetPassword(resetPasswordDto)).rejects.toThrow(BadRequestException);
      await expect(service.resetPassword(resetPasswordDto)).rejects.toThrow('Token expirado. Solicite um novo reset de senha.');
    });
    ...
    it('should throw BadRequestException when new password is too short', async () => {
      ...
      await expect(service.resetPassword(shortPasswordDto)).rejects.toThrow('A senha deve ter pelo menos 6 caracteres.');
    });
  });
});
