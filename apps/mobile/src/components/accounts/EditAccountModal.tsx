...
export function EditAccountModal({ visible, account, onDismiss, onSuccess }: EditAccountModalProps) {
  ...
  const handleSubmit = async (data: any) => {
    ...
    try {
      ...
      const creditLimit = data.creditLimit ? parseFloat(data.creditLimit.replace(',', '.')) : undefined;
