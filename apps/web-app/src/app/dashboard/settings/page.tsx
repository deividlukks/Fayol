...
import { CategoryManager } from '@/components/settings/category-manager'; // Importação do componente criado
import {
  Shield,
  Lock,
  Tag,
...
export default function SettingsPage() {
  ...
  const handleAddCategory = (type: LaunchType) => {
    ...
    console.log('Criar categoria do tipo:', type);
    alert('Funcionalidade de criar categoria personalizada em desenvolvimento.');
  };
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Adicione um método para upgrade.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <Card className="border-2 border-transparent">
              ...
              <CardContent className="space-y-2 text-sm text-slate-600">
                <div className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-emerald-500" /> Gestão de
                  Receitas/Despesas
                </div>
                <div className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-emerald-500" /> 2 Contas
                  Bancárias
                </div>
                <div className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-emerald-500" /> Relatórios
                  Básicos
                </div>
              </CardContent>
            </Card>
            <Card className="border-2 border-blue-600 bg-blue-50/30 relative overflow-hidden">
              ...
              <CardContent className="space-y-2 text-sm text-slate-700">
                ...
                <div className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-blue-600" /> IA de
                  Investimentos
                </div>
                <div className="flex gap-2">
                  <CheckCircle2 className="h-4 w-4 text-blue-600" /> Contas
                  Ilimitadas
                </div>
                <div className="flex gap-2">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-slate-500">
                    Resumos semanais e alertas de segurança.
                  </p>
                </div>
                <Switch checked={true} />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-amber-50 border border-amber-100 rounded-md p-3 flex gap-3 text-sm text-amber-800 mt-2">
                ...
                <p>
                  A alteração de senha e exclusão de conta requerem confirmação por
                  e-mail.
                </p>
              </div>
            </CardContent>
